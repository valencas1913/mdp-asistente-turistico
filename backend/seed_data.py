...
ACTIVIDADES = [
    ...
    dict(
        ...
        categoria="Playas",
        zona="Sur",
        descripcion="Balnearios con salida publica a la playa.",
        calificacion=4.6,
        recomendado_clima="soleado",
        horario="Todo el día",
    ),
   ...
   dict(
        nombre="Shopping Aldrey",
        categoria="Compras y paseos",
        zona="Centro",
        descripcion="Shopping de compras, cine y lugares recreativos.",
        calificacion=4.5,
        recomendado_clima="lluvia",
        horario="10:00 a 22:00",
    ),
   dict(
        nombre="Shopping Bendu",
        categoria="Compras y paseos",
        zona="Puerto",
        descripcion="Shopping de compras, cine y lugares recreativos.",
        calificacion=4.5,
    ...
    dict(
        ...
        categoria="Compras y paseos",
        zona="Playa Grande",
        descripcion="Centro comercial a cielo abierto.",
        calificacion=4.7,
        recomendado_clima="nublado",
        horario="10:00 a 22:00",
    ),
	dict(
        nombre="Avenida Constitucion",
        categoria="Compras y paseos",
        zona="Norte",
        descripcion="Centro comercial a cielo abierto.",
        calificacion=4.0,
	...
	dict(
        ...
        categoria="Cultura y Museos",
        zona="Norte",
        descripcion="Monumento Histórico Nacional de 1912 y lugar recreativo para los mas chicos.",
        calificacion=3.8,
        recomendado_clima="lluvia",
        horario="10:00 a 23:00",
    ),
    ...
    dict(
        nombre="Complejo la Normandina",
        categoria="Vida nocturna",
        zona="Playa Grande",
        descripcion="Complejo de boliches como Anana y Stadium.",
        calificacion=4.5,
        recomendado_clima="cualquira",
        horario="00:00 a 07:00",
    ),
    dict(
        nombre="Bendu Arena",
        categoria="Vida nocturna",
        zona="Puerto",
        descripcion="Espacio para recitales.",
        calificacion=4.5,
        recomendado_clima="cualquira",
    ...
    dict(
        ...
        categoria="Vida nocturna",
        zona="Faro",
        descripcion="Boliche en la playa.",
        calificacion=4.0,
        recomendado_clima="nublado",
        horario="00:00 a 07:00",
    ),
    dict(
        nombre="Plaza de la Musica",
        categoria="Vida nocturna",
        zona="Constitucion",
        descripcion="Salon de eventos para recitales.",
        calificacion=4.0,
        recomendado_clima="cualquira",
         horario="Según cartelera de eventos",
    ),
    ...
    dict(
        ...
        categoria="Aire libre",
        zona="Sur",
        descripcion="Complejo de toboganes acuaticos.",
        calificacion=4.5,
        recomendado_clima="soleado",
        ...
        categoria="Aire libre",
        zona="Sur",
        descripcion="Complejo de arbolismo.",
        calificacion=3.5,
        recomendado_clima="nublado",
    ...
    dict(
        nombre="Playas Chapadmalal",
        categoria="Playas",
        zona="Chapadmalal",
        descripcion="Playas alejadas y relajantes a las afueras de Mar del Plata",
        calificacion=3.5,
        recomendado_clima="soleado",
        horario="Todo el día",
    ),
	dict(
        ...
        descripcion="Este destino combina naturaleza, historia y tranquilidad, destacándose como uno de los paseos turísticos más elegidos de la región.",
        calificacion=3.6,
        recomendado_clima="cualquiera",
        horario="Todo el día",
    ),
	dict(
        ...
        categoria="Aire libre",
        zona="Sierra de los padres",
        descripcion="¡El escape verde ideal a solo 15 minutos de Mar del Plata! Un paraíso natural perfecto para desconectarse, acampar, remar y observar carpinchos en libertad.",
        calificacion=3.9,
        recomendado_clima="soleado",
        horario="Todo el día",
    ),
